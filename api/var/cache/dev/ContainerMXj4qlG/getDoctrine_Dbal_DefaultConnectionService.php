...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['doctrine.dbal.default_connection'] = $instance = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([], new \Doctrine\DBAL\Tools\DsnParser(['db2' => 'ibm_db2', 'mssql' => 'pdo_sqlsrv', 'mysql' => 'pdo_mysql', 'mysql2' => 'pdo_mysql', 'postgres' => 'pdo_pgsql', 'postgresql' => 'pdo_pgsql', 'pgsql' => 'pdo_pgsql', 'sqlite' => 'pdo_sqlite', 'sqlite3' => 'pdo_sqlite'])))->createConnection(['charset' => 'utf8mb4', 'dbname' => $container->getEnv('resolve:MYSQL_DATABASE'), 'driver' => 'pdo_mysql', 'host' => $container->getEnv('resolve:MYSQL_HOST'), 'password' => $container->getEnv('resolve:MYSQL_PASSWORD'), 'port' => $container->getEnv('resolve:MYSQL_PORT'), 'user' => $container->getEnv('resolve:MYSQL_USERNAME'), 'use_savepoints' => true, 'idle_connection_ttl' => 600, 'driverOptions' => [], 'serverVersion' => 'mariadb-10.3.24', 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci']], $a, ($container->privates['doctrine.dbal.default_connection.event_manager'] ?? $container->load('getDoctrine_Dbal_DefaultConnection_EventManagerService')), ['enum' => 'string']);
